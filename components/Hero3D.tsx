...
export default function Hero3D() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 w-full flex flex-col items-center justify-center text-center relative z-10 min-h-[calc(100vh-80px)]">
        ...
        >
          ...
          <motion.div
            ...
            className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 relative rounded-3xl overflow-hidden border border-outline shadow-2xl mb-4 bg-white"
          >
            <Image
              src="/images/logo.jpeg"
              alt="EduSimply Main Logo"
              fill
      ...
      >
        <span className="font-label-caps text-[9px] tracking-widest text-on-surface-variant uppercase font-semibold">
          Scroll to Learn
        </span>
