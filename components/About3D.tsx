      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start mb-16 md:mb-24">
          ...
          >
            ...
            >
              Over the years, she has tutored many students, helping them
              improve their confidence, prepare for exams, strengthen subject
              knowledge, and work towards their academic goals.
            </motion.p>
